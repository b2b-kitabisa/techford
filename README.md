...
|---|---|---|
| Employee | Login/identitas admin + manajemen user (juga referensi struktur modul) | Aktif |
| Lead Capturing | Sales Module — stat per status, search & filter, pagination, detail lead, Sync dari Inbound_Raw, Move ke Client | Aktif |
| Client Monitoring | Sales Module — daftar client, PIC per client, tambah client manual | Aktif |
